...
export default class scene16 extends Phaser.Scene
{
	...
	create()
	{
        ...
        this.add.text(640, 290,getPhrase ('CREDITOS'), {fontSize: '25px', fontFamily: 'Arial black', color: '#FFFFFF', })
      .setInteractive()  
      .on('pointerdown', () => this.scene.start('scene20') && click.play(),);
	  //this.add.text(640, 390, 'Menu Principal', { fontFamily: 'Arial black', color: '#FFFFFF', })
      //.setInteractive()  
